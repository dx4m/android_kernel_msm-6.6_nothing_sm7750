...
ocp_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	strlcat(buf, "\n", sizeof(buf));
	strlcat(buf, DRIVER_VERSION, sizeof(buf));
	strlcat(buf, "\n", sizeof(buf));

	switch (tp->version) {
	case RTL_VER_05:
		strlcat(buf, "RTL_VER_05\n", sizeof(buf));
		strlcat(buf, "usb_patch_code_20190904\n", sizeof(buf));
		strlcat(buf, "pla_patch_code_20190220_0\n", sizeof(buf));
		strlcat(buf, "\n\n\n\n", sizeof(buf));
		break;
	case RTL_VER_06:
		strlcat(buf, "RTL_VER_06\n", sizeof(buf));
		strlcat(buf, "usb_patch_20190909\n", sizeof(buf));
		strlcat(buf, "pla_patch_code_20190408_0\n", sizeof(buf));
		strlcat(buf, "\n\n\n\n", sizeof(buf));
		break;
	case RTL_VER_09:
		strlcat(buf, "RTL_VER_09\n", sizeof(buf));
		strlcat(buf, "usb_patch_code_20190906.cfg\n", sizeof(buf));
		strlcat(buf, "plamcu_patch_code_20190408_0\n", sizeof(buf));
		strlcat(buf, "\n\n\n\n", sizeof(buf));
		break;
	case RTL_VER_11:
		strlcat(buf, "RTL_VER_11\n", sizeof(buf));
		strlcat(buf, "nc0_patch_190128_usb\n", sizeof(buf));
		strlcat(buf, "nc1_patch_181029_usb\n", sizeof(buf));
		strlcat(buf, "nc2_patch_180821_usb\n", sizeof(buf));
		strlcat(buf, "uc2_patch_181018_usb\n", sizeof(buf));
		strlcat(buf, "data_ram_patch_v02_usb\n", sizeof(buf));
		strlcat(buf, "100m_tx_coefficient_180716_usb\n", sizeof(buf));
		strlcat(buf, "USB_patch_code_20210310_v4\n", sizeof(buf));
		strlcat(buf, "PLA_patch_code_20210318_v6\n", sizeof(buf));
		break;
	case RTL_VER_12:
		strlcat(buf, "RTL_VER_12\n", sizeof(buf));
		strlcat(buf, "nc_patch_190821_usb\n", sizeof(buf));
		strlcat(buf, "nc2_patch_190823_usb\n", sizeof(buf));
		strlcat(buf, "uc2_patch_190817_usb\n", sizeof(buf));
		strlcat(buf, "uc_patch_190731_usb\n", sizeof(buf));
		strlcat(buf, "USB_patch_code_20190816_v2\n", sizeof(buf));
		strlcat(buf, "PLA_patch_code_20190827_v2\n", sizeof(buf));
		break;
	case RTL_VER_13:
	case RTL_VER_15:
		strlcat(buf, "RTL_VER_13\n", sizeof(buf));
		strlcat(buf, "tgphy_ramcode_v21_usb_20220324\n", sizeof(buf));
		strlcat(buf, "\n", sizeof(buf));
		strlcat(buf, "\n", sizeof(buf));
		strlcat(buf, "\n", sizeof(buf));
		strlcat(buf, "USB_patch_code_20220314_v4\n", sizeof(buf));
		strlcat(buf, "PLA_SVN8948_20220330_v06\n", sizeof(buf));
		break;
	case RTL_VER_14:
		strlcat(buf, "RTL_VER_14\n", sizeof(buf));
		strlcat(buf, "USB_Patch_Code_svn3347\n", sizeof(buf));
		strlcat(buf, "PLA_Patch_Code_svn3346\n", sizeof(buf));
		strlcat(buf, "\n\n\n\n", sizeof(buf));
		break;
	default:
		strlcat(buf, "\n\n\n\n\n\n\n", sizeof(buf));
	...
	snprintf(tmp, sizeof(tmp), "tx_packets = %Lu\n", le64_to_cpu(tally.tx_packets));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "rx_packets = %Lu\n", le64_to_cpu(tally.rx_packets));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_errors = %Lu\n", le64_to_cpu(tally.tx_errors));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_errors = %u\n", le32_to_cpu(tally.rx_errors));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "rx_missed = %u\n", le16_to_cpu(tally.rx_missed));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "align_errors = %u\n", le16_to_cpu(tally.align_errors));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_one_collision = %u\n",
		le32_to_cpu(tally.tx_one_collision));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_multi_collision = %u\n",
		le32_to_cpu(tally.tx_multi_collision));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "rx_unicast = %Lu\n", le64_to_cpu(tally.rx_unicast));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "rx_broadcast = %Lu\n", le64_to_cpu(tally.rx_broadcast));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "rx_multicast = %u\n", le32_to_cpu(tally.rx_multicast));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_aborted = %u\n", le16_to_cpu(tally.tx_aborted));
	strlcat(buf, tmp, sizeof(buf));
	snprintf(tmp, sizeof(tmp), "tx_underrun = %u\n", le16_to_cpu(tally.tx_underrun));
	strlcat(buf, tmp, sizeof(buf));
				...
				struct device_attribute *attr, char *buf)
{
	...
	if (!tp->fc_pause_on)
		snprintf(buf, sizeof(buf), "(Auto)%u\n", fc_pause_on_auto(tp));
	else
		snprintf(buf, sizeof(buf), "%u\n", tp->fc_pause_on);
