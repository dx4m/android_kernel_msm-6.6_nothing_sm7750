...
#define XGMAC_TIMESTAMP_BASE_ADDR		0x00007000
#define XGMAC_MTLQ_BASE_ADDR			0x00008000
#define XGMAC_DMA_CHAN_BASE_ADDR		0x0000E000
#define XGMAC_CH_OFFSET					0x00001000

#define XGMAC_PPS_BASE_OFFSET			0x00000010
#define XGMAC_PPS_BASE_ADDR(x)			(XGMAC_TIMESTAMP_BASE_ADDR + \
						(x * XGMAC_PPS_BASE_OFFSET))
#define XGMAC_MTLQX_BASE_ADDR(x)		(XGMAC_MTLQ_BASE_ADDR + \
						(x * XGMAC_CH_OFFSET))
#define XGMAC_DMA_CHANX_BASE_ADDR(x)	(XGMAC_DMA_CHAN_BASE_ADDR + \
						(x * XGMAC_CH_OFFSET))
...
#define XGMAC_VLAN_CTRL_TAG		0x00000050
#define XGMAC_VLAN_DATA_TAG		0x00000054
...
#define XGMAC_MTL_RX_QMAP		0x00001030

/*MAC VLAN CTRL Bit*/
#define XGMAC_VLANTR_OB_MASK		(0x1)
#define XGMAC_VLANTR_CT_MASKBIT		BIT(1)
#define XGMAC_VLANTR_OFFSET_SHIFT	2
#define XGMAC_VLANTR_VLAN_EN		BIT(16)
#define XGMAC_VLANTR_VLAN_CMP		BIT(17)
#define XGMAC_VLANTR_VLAN_CMP_DISABLE	BIT(18)
#define XGMAC_VLANTR_DMA_CHAN_EN	BIT(24)
#define XGMAC_VLANTR_DMA_CHAN_NUM	25
...
#define XGMAC_TIMESTAMP_STATUS		(XGMAC_TIMESTAMP_BASE_ADDR + 0x20)
#define XGMAC_TXTSC			BIT(15)
#define XGMAC_TXTIMESTAMP_NSEC		(XGMAC_TIMESTAMP_BASE_ADDR + 0x30)
#define XGMAC_TXTSSTSLO			GENMASK(30, 0)
#define XGMAC_TXTIMESTAMP_SEC		(XGMAC_TIMESTAMP_BASE_ADDR + 0x34)
#define XGMAC_PPS_CONTROL			(XGMAC_TIMESTAMP_BASE_ADDR + 0x70)
#define XGMAC_TXTIMESTAMP_PKTID		(XGMAC_TIMESTAMP_BASE_ADDR + 0x38)
...
#define XGMAC_ADDR			GENMASK(8, 0)
#define XGMAC_ACCSEL			GENMASK(25, 24)
...
#define XGMAC_MTL_TXQ_OPMODE(x)		(XGMAC_MTLQX_BASE_ADDR(x))
...
#define XGMAC_MTL_TCx_ETS_CONTROL(x)		(XGMAC_MTLQX_BASE_ADDR(x) + 0x10)
...
#define XGMAC_MTL_RXQ_OPMODE(x)		(XGMAC_MTLQX_BASE_ADDR(x) + 0x40)
...
#define XGMAC_MTL_QINTEN(x)		(XGMAC_MTLQX_BASE_ADDR(x) + 0x70)
#define XGMAC_RXOIE			BIT(16)
#define XGMAC_MTL_QINT_STATUS(x)		(XGMAC_MTLQX_BASE_ADDR(x) + 0x74)
...
#define XGMAC_DMA_CH_CONTROL(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x))
#define XGMAC_SPH			BIT(24)
#define XGMAC_PBLx8			BIT(16)
#define XGMAC_DMA_CH_TX_CONTROL(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x04)
...
#define XGMAC_RBSZ_SHIFT		4
#define XGMAC_RXST			BIT(0)
#define XGMAC_DMA_CH_TxDESC_HADDR(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x10)
#define XGMAC_DMA_CH_TxDESC_LADDR(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x14)
#define XGMAC_DMA_CH_RxDESC_HADDR(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) +  0x18)
#define XGMAC_DMA_CH_RxDESC_LADDR(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x1c)
#define XGMAC_DMA_CH_TxDESC_TAIL_LPTR(x)	(XGMAC_DMA_CHANX_BASE_ADDR(x) +  0x24)
#define XGMAC_DMA_CH_RxDESC_TAIL_LPTR(x)	(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x2c)
#define XGMAC_DMA_CH_TxDESC_RING_LEN(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x30)
#define XGMAC_DMA_CH_RxDESC_RING_LEN(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x34)
#define XGMAC_DMA_CH_INT_EN(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) +  0x38)
...
#define XGMAC_DMA_INT_DEFAULT_EN	(XGMAC_NIS | XGMAC_AIS | XGMAC_FBE)
#define XGMAC_DMA_INT_DEFAULT_RX	(XGMAC_RBUE | XGMAC_RIE)
#define XGMAC_DMA_INT_DEFAULT_TX	(XGMAC_TIE)
#define XGMAC_DMA_CH_Rx_WATCHDOG(x)		(XGMAC_DMA_CHANX_BASE_ADDR(x) +  0x3c)
#define XGMAC_RWT			GENMASK(7, 0)
#define XGMAC_DMA_CH_STATUS(x)			(XGMAC_DMA_CHANX_BASE_ADDR(x) + 0x60)
...
#define XGMAC_RXQCTRL_TPQE		GENMASK(22, 21)
#define XGMAC_RXQCTRL_TPQE_SHIFT	21
#define XGMAC_RXQCTRL_OMCBCQEN	20
...
/*12 to 14 bits are reserved to not write anything*/
#define XGMAC_RXQCTRL_MCBCQ_MASK		GENMASK(11, 8)
#define XGMAC_RXQCTRL_MCBCQ_SHIFT	8
#define XGMAC_RXQCTRL_FPRQ		GENMASK(7, 4)
