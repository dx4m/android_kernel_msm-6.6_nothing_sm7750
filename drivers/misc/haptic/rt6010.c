...
static bool rt6010_is_error_state(struct ics_haptic_data *haptic_data)
{
	return ((haptic_data->irq_state & RT6010_BIT_INTS_INVALID) > 0);
}
...
struct ics_haptic_func rt6010_func_list =
{
	...
	.is_error_state = rt6010_is_error_state,
